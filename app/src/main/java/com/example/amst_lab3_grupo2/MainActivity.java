...
// Credenciales: (user: lab3_grupo2, password: aprobado123)
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Creamos una variable lista (queue) de las solicitudes (request) a ejecutar
        mQueue = Volley.newRequestQueue(this);
    }

    // IrMenuPrincipal desplaza la vista del telefono entre actividades
